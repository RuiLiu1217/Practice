...
int LC::_0159_LongestSubstringWithAtMostTwoDistinctCharacters::lengthOfLongestSubstringTwoDistinct(std::string s) {
...
int LC::_1358_NumberOfSubstringsContainingAllThreeCharacters::numberOfSubstrings(std::string s) {
    int endPoint = 0;
    int res = 0;
    const int N = s.size();
