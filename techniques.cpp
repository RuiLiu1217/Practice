...
void MultiMap() {
    ...
    Map.insert(std::pair(1,40));
    Map.insert(std::pair(2,30));
    Map.insert(std::pair(3,20));
    Map.insert(std::pair(4,10));
    Map.insert(std::pair(1,10)); // duplicate
    Map.insert(std::pair(1,20)); // duplicate key 1 -> 40, 10, 20
